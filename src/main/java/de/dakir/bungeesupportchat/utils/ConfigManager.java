...
public class ConfigManager {
    ...
    public static void load() {
        ...
        try {
            ...
            Strings.dataSupportsReset = ChatColor.translateAlternateColorCodes('&', HexxAPI.getStringWithColorCodes(config.getString("dataSupportsReset")));
            ...
            Strings.sc_data_reset = ChatColor.translateAlternateColorCodes('&', HexxAPI.getStringWithColorCodes(config.getString("sc_data_reset")));
    ...
    public static void loadConfigBackup() {
        try {
            ...
            if (config.contains("enableQueueNotification"))
            ...
            if (config.contains("commandNotExists"))
            ...
            if (config.contains("playerIsSupporter"))
                ConfigBackup.playerIsSupporter = config.getString("playerIsSupporter");
            if (config.contains("notInSupportChat"))
                ConfigBackup.notInSupportChat = config.getString("notInSupportChat");
            if (config.contains("inSupportChat")) ConfigBackup.inSupportChat = config.getString("inSupportChat");
            if (config.contains("playerIsInSupportChat"))
                ConfigBackup.playerIsInSupportChat = config.getString("playerIsInSupportChat");
            if (config.contains("noSupportNeeded")) ConfigBackup.noSupportNeeded = config.getString("noSupportNeeded");
            if (config.contains("noSupporterOnline"))
                ConfigBackup.noSupporterOnline = config.getString("noSupporterOnline");
            if (config.contains("noSupportRequest"))
                ConfigBackup.noSupportRequest = config.getString("noSupportRequest");
            if (config.contains("joinSupportQueue"))
                ConfigBackup.joinSupportQueue = config.getString("joinSupportQueue");
            if (config.contains("leaveSupportQueue"))
                ConfigBackup.leaveSupportQueue = config.getString("leaveSupportQueue");
            ...
            if (config.contains("onePlayerNeedSupport"))
                ConfigBackup.onePlayerNeedSupport = config.getString("onePlayerNeedSupport");
            if (config.contains("morePlayerNeedSupport"))
                ConfigBackup.morePlayerNeedSupport = config.getString("morePlayerNeedSupport");
            if (config.contains("playerInQueue")) ConfigBackup.playerInQueue = config.getString("playerInQueue");
            if (config.contains("closeSupportChat"))
                ConfigBackup.closeSupportChat = config.getString("closeSupportChat");
            if (config.contains("openSupportChat")) ConfigBackup.openSupportChat = config.getString("openSupportChat");
            if (config.contains("openSupportChat_head"))
                ConfigBackup.openSupportChat_head = config.getString("openSupportChat_head");
            if (config.contains("openSupportChat_user"))
                ConfigBackup.openSupportChat_user = config.getString("openSupportChat_user");
            if (config.contains("openSupportChat_space"))
                ConfigBackup.openSupportChat_space = config.getString("openSupportChat_space");
            if (config.contains("openSupportChat_hellomessage"))
                ConfigBackup.openSupportChat_hellomessage = config.getString("openSupportChat_hellomessage");
            if (config.contains("mysqlNotEnabled")) ConfigBackup.mysqlNotEnabled = config.getString("mysqlNotEnabled");
            if (config.contains("dataSupportsReset"))
                ConfigBackup.dataSupportsReset = config.getString("dataSupportsReset");
            if (config.contains("dataPlayerStats")) ConfigBackup.dataPlayerStats = config.getString("dataPlayerStats");
            if (config.contains("dataPlayerDeleted"))
                ConfigBackup.dataPlayerDeleted = config.getString("dataPlayerDeleted");
            if (config.contains("dataPlayerSupportsAdded"))
                ConfigBackup.dataPlayerSupportsAdded = config.getString("dataPlayerSupportsAdded");
            if (config.contains("dataPlayerSupportsRemoved"))
                ConfigBackup.dataPlayerSupportsRemoved = config.getString("dataPlayerSupportsRemoved");
            if (config.contains("dataPlayerSupportsSet"))
                ConfigBackup.dataPlayerSupportsSet = config.getString("dataPlayerSupportsSet");
            if (config.contains("dataPlayerList_header"))
                ConfigBackup.dataPlayerList_header = config.getString("dataPlayerList_header");
            if (config.contains("dataPlayerList_entry"))
                ConfigBackup.dataPlayerList_entry = config.getString("dataPlayerList_entry");
            if (config.contains("dataPlayerList_footer"))
                ConfigBackup.dataPlayerList_footer = config.getString("dataPlayerList_footer");
